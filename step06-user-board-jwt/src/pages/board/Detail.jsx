...
const Detail = () => {
  ...
  return (
    <div>
      <h1>상세보기</h1>
      <Button
        variant="warning" //색깔 지정
        onClick={updateBoard}
        disabled={ // true일때 비활성화 false일때 활성화
      ...
      <Button
        variant="danger"    //색깔 지정
        onClick={() => deleteBoard(board.id)}
        disabled={ // true일때 비활성화 false일떄 활성화
            board.member.id === localStorage.getItem("id") ? false : true}
      >
        삭제
      </Button>
      <hr />
